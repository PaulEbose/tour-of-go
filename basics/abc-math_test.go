...
func TestSqrt(t *testing.T) {
	cases := []struct {
		...
		{[]float64{1, 4, -9, 16, 25}, []string{"1", "2", "3i", "4", "5"}},
		{[]float64{27.5625, 11.9716, 144}, []string{"5.25", "3.46", "12"}},
		{[]float64{81, 64, -225}, []string{"9", "8", "15i"}},
		{[]float64{-121, 36}, []string{"11i", "6"}},
		{[]float64{100, -5625, 1089, 1702.3876, 256, 8317.44}, []string{"10", "75i", "33", "41.26", "16", "91.2"}},
	}
